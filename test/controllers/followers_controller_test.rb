...
class FollowersControllerTest < ActionController::TestCase
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post :create, follower: { celebrity_id: @follower.celebrity_id, handle: @follower.handle, uid: @follower.uid }
    end
  ...
  test "should update follower" do
    patch :update, id: @follower, follower: { celebrity_id: @follower.celebrity_id, handle: @follower.handle, uid: @follower.uid }
    assert_redirected_to follower_path(assigns(:follower))
  end
